...
import mi.paquete.externa;


public class Main {
    static void main() {
        interna campoInterno;
        externa campoExterno; //como externa está en otra ruta, hay que hacer un import con la ruta. (import mi.paquete.externa;)
        ...
        float f =l;
        double d = f;
        //char ch =s; //sale en rojo por que de short a char se pierde informacion, y habria que hacer una conversion explicita.
