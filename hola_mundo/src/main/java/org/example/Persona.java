...
public class Persona {
    private String nombre;      //Si ponemos private detras de las variables, ya solo podemos acceder a ellas usando get o set
    ...
    //Constructor persona con datos minimos
