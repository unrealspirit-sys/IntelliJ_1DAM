...
public class Calcular3NotasCodigoVictor {
    ...
    public class Main {
        ...
        public static void main() {
            ...
            double nota1 = leerNota("Introduce la nota de prácticas");
            double nota2 = leerNota("Introduce la nota de problemas");
            double nota3 = leerNota("Introduce la nota de teoría");
        ...
        static double leerNota(String mensaje) {
            ...
            do {
                ...
                if (sc.hasNextDouble()) {
                    ...
                    if (n < 0.0 || n > 10.0) n = CODIGO_ERROR;
                } else {
