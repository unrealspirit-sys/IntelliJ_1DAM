public class Ejercicios_teams_16_11_2025 {
    static void main(){
//        Vamos a revisar algunos de los ejercicios de pseudocódigo, esta vez implementándolos en Java:
//        1)     Desarrolla una aplicación que calcule el área y el perímetro de una circunferencia.
//        2)     Se tienen tres variables A, B, C de tipo int.
//                Escribir una aplicación que haga los siguientes intercambios usando sólo una variable auxiliar:
...
//        8 x 3 = 24
//        8 x 10 = 80
//        4) Escribe un programa que muestre los múltiplos de 5 entre 1 y 100 utilizando un bucle y condicionales para filtrarlos.
        //Ejercicio 1
