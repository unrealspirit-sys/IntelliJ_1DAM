...
//Función mayor que
 public static void mayorQue (int num1, int num2 ){
    if (num1 > num2) IO.println ("Resultado: "+num1+ "es mayor que "+num2);
    else if (num2 > num1) IO.println ("Resultado: "+num2+ "es mayor que "+num1);
    else IO.println ("Resultado: Son iguales");
    }
 ...
 public int leerNumeros (String mensaje){
        ...
        IO.println (mensaje);
        int retorno = -1111;
        if (sc.hasNextInt()) retorno = sc.nextInt();
        else IO.println("Error al introducir el numero");
        return retorno;
 }
