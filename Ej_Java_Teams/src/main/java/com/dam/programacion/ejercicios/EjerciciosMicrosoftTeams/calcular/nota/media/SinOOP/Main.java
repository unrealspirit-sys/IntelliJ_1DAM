package com.dam.programacion.ejercicios.EjerciciosMicrosoftTeams.calcular.nota.media.SinOOP;
        ...
        for ( int i = 0; i < numAlumnos; i++){
            ...
            double sumaNotas = 0;
             for (int j = 0; j < notas.length; j++){
                 ...
                 sumaNotas += inputNota; //cada nota obtenida la vamos sumando en la variable sumaNotas, que guarda el resultado total.
             }
             sc.nextLine();
             //Calculos
            ...
            } else System.out.println( " Suspenso. Esfuerzaté !");
            System.out.println(" ---------------- ");
        }
        sc.close();
    }
